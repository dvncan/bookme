          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="mt-4 text-xl text-blue-100">
                Let your clients book appointments without the back-and-forth
                emails. Available 24/7.
              </p>
              <div className="mt-8">
                <Link to="/booking">
                  <Button
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 transform rotate-1 transition-transform hover:rotate-0">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded p-4 mb-4">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-xs bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300 py-1 px-2 rounded">
                      Step 1 of 3
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <div className="px-3 py-2 border border-gray-200 dark:border-gray-700 rounded text-sm">
                      10:00 AM
                    </div>
                    <div className="px-3 py-2 border border-gray-200 dark:border-gray-700 rounded text-sm">
                      11:00 AM
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Let clients book appointments anytime, even outside business
                hours. No more missed opportunities.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our system automatically prevents scheduling conflicts by only
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                A clean, intuitive interface makes it easy for clients to select
                dates, times, and complete bookings.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 rounded-2xl p-8 md:p-12 shadow-xl">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
                Start booking appointments today and save time for what really
                matters
              </p>
              <Link to="/booking">
                <Button
